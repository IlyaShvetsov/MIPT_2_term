...
bool CBoard::CanRight() const {
    return null_pos != 3 && null_pos != 7 && null_pos != 11 && null_pos != 15;
}

bool CBoard::CanLeft() const {
    return null_pos != 0 && null_pos != 4 && null_pos != 8 && null_pos != 12;
}

bool CBoard::CanUp() const {
    return null_pos != 0 && null_pos != 1 && null_pos != 2 && null_pos != 3;
}

bool CBoard::CanDown() const {
    return null_pos != 12 && null_pos != 13 && null_pos != 14 && null_pos != 15;
}
